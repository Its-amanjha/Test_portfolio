...
export const FooterSection = {
  ...
  // Multi-column variant (legacy layout preserved here for clean composition structure)
  MultiColumn: function FooterMultiColumn({
    brandName,
    bio,
    quickLinks,
    socialLinks,
      ...
      <div className="w-full max-w-6xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center md:text-left space-y-3">
            <h3 className="inline-block bg-neo-yellow border-2 border-black px-2 py-1 font-extrabold text-sm uppercase">
              About
            </h3>
            <p className="text-sm leading-relaxed font-semibold text-[color:var(--neo-ink-soft)]">
              {bio}
            </p>
          </div>
          ...
          {/* Quick Links */}
          <div className="text-center md:text-left space-y-3">
            <h3 className="inline-block bg-neo-cyan border-2 border-black px-2 py-1 font-extrabold text-sm uppercase">
              Quick Links
            </h3>
            <ul className="space-y-2 text-sm">
              {quickLinks.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="font-semibold hover:bg-neo-yellow hover:px-1 transition-all duration-100 text-[color:var(--neo-ink)]"
                  >
                    {link.label}
                  </a>
                </li>
          ...
          {/* Connect */}
          <div className="text-center md:text-left space-y-3">
            <h3 className="inline-block bg-neo-pink border-2 border-black px-2 py-1 font-extrabold text-sm uppercase">
              Connect
            </h3>
        ...
        {/* Footer bottom */}
        <div className="pt-5 text-center border-t-2 border-black">
