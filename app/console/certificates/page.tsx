    ...
    <section className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="neo-card p-8 space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block font-extrabold mb-2 text-[color:var(--neo-ink)]">Certificate Title *</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block font-extrabold mb-2 text-[color:var(--neo-ink)]">Issuer *</label>
            <input
              type="text"
              required
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block font-extrabold mb-2 text-[color:var(--neo-ink)]">Issue Date *</label>
            <input
              type="date"
              required
          ...
          <div>
            <label className="block font-extrabold mb-2 text-[color:var(--neo-ink)]">Credential URL (optional)</label>
            <input
              type="url"
        ...
        <div>
          <label className="block font-extrabold mb-2 text-[color:var(--neo-ink)]">Description (optional)</label>
          <textarea
        ...
        <div>
          <label className="block font-extrabold mb-2 text-[color:var(--neo-ink)]">Technologies/Skills (optional)</label>
          <TagSearchInput
            value={formData.tags}
            ...
            className="neo-input"
          />
          <p className="text-xs mt-1 text-[color:var(--neo-ink-soft)]">Comma-separated list of technologies</p>
        </div>
