    ...
    <section className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="neo-card p-6 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            <label className="block font-extrabold mb-2 text-sm text-[color:var(--neo-ink)]">Job Title *</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block font-extrabold mb-2 text-sm text-[color:var(--neo-ink)]">Organization *</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="block font-extrabold mb-2 text-sm text-[color:var(--neo-ink)]">Location</label>
            <input
              type="text"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block font-extrabold mb-2 text-sm text-[color:var(--neo-ink)]">Start Date *</label>
            <input
              type="date"
              required
          ...
          <div>
            <label className="block font-extrabold mb-2 text-sm text-[color:var(--neo-ink)]">End Date</label>
            <div className="flex flex-col gap-2">
              <div className="flex gap-4 py-1.5">
                <label className="flex items-center gap-1.5 cursor-pointer">
                  ...
                  />
                  <span className="font-bold text-sm text-[color:var(--neo-ink)]">Present</span>
                </label>
                <label className="flex items-center gap-1.5 cursor-pointer">
                  <input
                    type="radio"
                    ...
                    className="w-4 h-4 accent-black border-2 border-black focus:ring-0 cursor-pointer"
                  />
                  <span className="font-bold text-sm text-[color:var(--neo-ink)]">Specific Date</span>
                </label>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block font-extrabold mb-2 text-sm text-[color:var(--neo-ink)]">Key Highlights (one per line)</label>
            <textarea
        ...
        <div>
          <label className="block font-extrabold mb-2 text-sm text-[color:var(--neo-ink)]">Technologies/Skills (comma-separated)</label>
          <TagSearchInput
            value={formData.tags}
            ...
            className="neo-input"
          />
          <p className="text-xs mt-1.5 text-[color:var(--neo-ink-soft)] font-bold">Supported: Python, JavaScript, TypeScript, React, Next.js, Node.js, Claude, OpenAI, Codex, LangChain, TensorFlow, PyTorch, Docker, AWS, GCP, Prisma, Stripe, Clerk, SQL, MongoDB, PostgreSQL, Git, and more</p>
        </div>
